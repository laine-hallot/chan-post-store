(function (global, factory) {
  ...
  function replaceCodePoint(codePoint) {
    ...
    if ((codePoint >= 55296 && codePoint <= 57343) || codePoint > 1114111)
      return 65533;
    return (_decodeMap$get = decodeMap.get(codePoint)) !== null &&
      _decodeMap$get !== void 0
      ? _decodeMap$get
      : codePoint;
  }
  //#endregion
  ...
  var EntityDecoder = class {
    ...
    emitNumericEntity(lastCp, expectedLength) {
      if (this.consumed <= expectedLength) {
        var _this$errors;
        (_this$errors = this.errors) === null ||
          _this$errors === void 0 ||
          _this$errors.absenceOfDigitsInNumericCharacterReference(
            this.consumed
          );
        return 0;
      }
    ...
    emitNotTerminatedNamedEntity() {
      ...
      (_this$errors2 = this.errors) === null ||
        _this$errors2 === void 0 ||
        _this$errors2.missingSemicolonAfterCharacterReference();
      return this.consumed;
    }
    /**
     * Emit a named entity.
     ...
     */
      ...
      switch (this.state) {
        ...
        case EntityDecoderState.NumericStart:
          var _this$errors3;
          (_this$errors3 = this.errors) === null ||
            _this$errors3 === void 0 ||
            _this$errors3.absenceOfDigitsInNumericCharacterReference(
              this.consumed
            );
          return 0;
        case EntityDecoderState.EntityStart:
  ...
  function determineBranch(decodeTree, current, nodeIndex, char) {
    ...
    while (lo <= hi) {
      const mid = (lo + hi) >>> 1;
      const midKey =
        (decodeTree[nodeIndex + (mid >> 1)] >> ((mid & 1) * 8)) & 255;
  ...
  function encodeXML$1(input) {
    ...
    for (let index = 0; index < length; index++) {
      ...
      if (
        char < 128 &&
        (((1342177476 >>> char) & 1) === 0 || char >= 64 || char < 32)
      )
        continue;
   ...
   * @param data String to escape.
   */
  const escapeAttribute$1 = /* #__PURE__ */ getEscaper$1(
    /["&\u00A0]/g,
    /* @__PURE__ */ new Map([
      [34, '&quot;'],
      [38, '&amp;'],
   ...
   * @param data String to escape.
   */
  const escapeText$1 = /* #__PURE__ */ getEscaper$1(
    /[&<>\u00A0]/g,
    /* @__PURE__ */ new Map([
      [38, '&amp;'],
      [60, '&lt;'],
  ...
  const htmlTrie = /* #__PURE__ */ parseEncodeTrie(
  ...
  const HTML_BITSET = /* #__PURE__ */ new Uint32Array([
    5632, 4227923966, 4160749569, 939524097,
  ]);
  ...
  function renderTag(elem, opts) {
    ...
    if (opts.xmlMode === 'foreign') {
      ...
      if (elem.parent && foreignModeIntegrationPoints.has(elem.parent.name))
        opts = _objectSpread2(_objectSpread2({}, opts), {}, { xmlMode: false });
    }
  ...
  var require_boolbase = /* @__PURE__ */ __moduleMin((exports, module) => {
    module.exports = {
  ...
  //#endregion
  //#region node_modules/css-what/lib/module/types.js
  var require_types = /* @__PURE__ */ __moduleMin((exports) => {
  ...
  //#endregion
  //#region node_modules/css-what/lib/module/parse.js
  var require_parse = /* @__PURE__ */ __moduleMin((exports) => {
    Object.defineProperty(exports, '__esModule', { value: true });
  ...
  //#endregion
  //#region node_modules/css-what/lib/module/stringify.js
  var require_stringify = /* @__PURE__ */ __moduleMin((exports) => {
    var __spreadArray =
  ...
  //#endregion
  //#region node_modules/css-what/lib/module/index.js
  var require_module = /* @__PURE__ */ __moduleMin((exports) => {
    var __createBinding =
  ...
  var import_module = require_module();
  const procedure = /* @__PURE__ */ new Map([
    [import_module.SelectorType.Universal, 50],
    [import_module.SelectorType.Tag, 30],
    [import_module.SelectorType.Attribute, 1],
    [import_module.SelectorType.Pseudo, 0],
  ]);
  function isTraversal(token) {
    return !procedure.has(token.type);
  }
  const attributes = /* @__PURE__ */ new Map([
    [import_module.AttributeAction.Exists, 10],
    [import_module.AttributeAction.Equals, 8],
    [import_module.AttributeAction.Not, 7],
    [import_module.AttributeAction.Start, 6],
    [import_module.AttributeAction.End, 6],
    [import_module.AttributeAction.Any, 5],
  ]);
  /**
  ...
  function getProcedure(token) {
    ...
    if (token.type === import_module.SelectorType.Attribute) {
      proc =
        (_b = attributes.get(token.action)) !== null && _b !== void 0 ? _b : 4;
      if (
        token.action === import_module.AttributeAction.Equals &&
        token.name === 'id'
      )
        proc = 9;
      if (token.ignoreCase) proc >>= 1;
    } else if (token.type === import_module.SelectorType.Pseudo)
  ...
  const filters = {
    ...
    'nth-child'(next, rule, { adapter, equals }) {
      ...
      if (func === import_boolbase.default.falseFunc)
        return import_boolbase.default.falseFunc;
      if (func === import_boolbase.default.trueFunc)
  ...
  const pseudos = {
    empty(elem, { adapter }) {
      return !adapter
        .getChildren(elem)
        .some((elem) => adapter.isTag(elem) || adapter.getText(elem) !== '');
    },
  ...
  function ensureIsTag(next, adapter) {
    if (next === import_boolbase.default.falseFunc)
      return import_boolbase.default.falseFunc;
  ...
  const is$1 = (next, token, options, context, compileToken) => {
    ...
    return func === import_boolbase.default.trueFunc
      ? next
      : func === import_boolbase.default.falseFunc
        ? import_boolbase.default.falseFunc
  ...
  const subselects = {
    ...
    not(next, token, options, context, compileToken) {
      const func = compileToken(token, copyOptions(options), context);
      return func === import_boolbase.default.falseFunc
        ? next
        : func === import_boolbase.default.trueFunc
          ? import_boolbase.default.falseFunc
          : (elem) => !func(elem) && next(elem);
    },
    has(next, subselect, options, _context, compileToken) {
      ...
      if (compiled === import_boolbase.default.falseFunc)
        return import_boolbase.default.falseFunc;
  ...
  function compilePseudoSelector(
    ...
    if (typeof stringPseudo === 'string') {
      ...
      const alias = (0, import_module.parse)(stringPseudo);
  ...
  function compileGeneralSelector(
    ...
    switch (selector.type) {
      case import_module.SelectorType.PseudoElement:
        throw new Error('Pseudo-elements are not supported by css-select');
      case import_module.SelectorType.ColumnCombinator:
        throw new Error(
          'Column combinators are not yet supported by css-select'
        );
      case import_module.SelectorType.Attribute:
      ...
      case import_module.SelectorType.Pseudo:
      ...
      case import_module.SelectorType.Tag: {
        if (selector.namespace != null)
          throw new Error(
      ...
      case import_module.SelectorType.Descendant: {
      ...
      case '_flexibleDescendant':
        return function flexibleDescendant(elem) {
          let current = elem;
          do if (next(current)) return true;
          while ((current = getElementParent(current, adapter)));
          return false;
        };
      case import_module.SelectorType.Parent:
        return function parent(elem) {
          return adapter
            .getChildren(elem)
            .some((elem) => adapter.isTag(elem) && next(elem));
        };
      case import_module.SelectorType.Child:
        return function child(elem) {
          const parent = adapter.getParent(elem);
          return parent != null && adapter.isTag(parent) && next(parent);
        };
      case import_module.SelectorType.Sibling:
      ...
      case import_module.SelectorType.Adjacent:
        if (adapter.prevElementSibling)
      ...
      case import_module.SelectorType.Universal:
  ...
  function compile$1(selector, options, context) {
    return ensureIsTag(
      compileUnsafe(selector, options, context),
      options.adapter
    );
  }
  function compileUnsafe(selector, options, context) {
    return compileToken(
      typeof selector === 'string'
        ? (0, import_module.parse)(selector)
        : selector,
      options,
      context
    );
  ...
  function includesScopePseudo(t) {
    return (
      t.type === import_module.SelectorType.Pseudo &&
      (t.name === 'scope' ||
        (Array.isArray(t.data) &&
          t.data.some((data) => data.some(includesScopePseudo))))
    );
  }
  const DESCENDANT_TOKEN = { type: import_module.SelectorType.Descendant };
  const FLEXIBLE_DESCENDANT_TOKEN = { type: '_flexibleDescendant' };
  const SCOPE_TOKEN = {
    type: import_module.SelectorType.Pseudo,
    name: 'scope',
    data: null,
  };
  function absolutize(token, { adapter }, context) {
    ...
    for (const t of token) {
      if (
        t.length > 0 &&
        isTraversal(t[0]) &&
        t[0].type !== import_module.SelectorType.Descendant
      ) {
    ...
    const query = token
      .map((rules) => {
        if (rules.length >= 2) {
          ...
          if (
            first.type !== import_module.SelectorType.Pseudo ||
            first.name !== 'scope'
          ) {
          } else if (
            isArrayContext &&
            second.type === import_module.SelectorType.Descendant
          )
            rules[1] = FLEXIBLE_DESCENDANT_TOKEN;
          else if (
            second.type === import_module.SelectorType.Adjacent ||
            second.type === import_module.SelectorType.Sibling
          )
  ...
  function compileRules(rules, options, context) {
    ...
    return rules.reduce(
      (previous, rule) =>
        previous === import_boolbase.default.falseFunc
          ? import_boolbase.default.falseFunc
      ...
      (_a = options.rootFunc) !== null && _a !== void 0
        ? _a
        : import_boolbase.default.trueFunc
    );
  }
  function reduceRules(a, b) {
    if (
      b === import_boolbase.default.falseFunc ||
      a === import_boolbase.default.trueFunc
    )
      return a;
    if (
      a === import_boolbase.default.falseFunc ||
      b === import_boolbase.default.trueFunc
    )
      return b;
  ...
  const selectAll = getSelectorFunc((query, elems, options) =>
    query === import_boolbase.default.falseFunc || !elems || elems.length === 0
      ? []
  ...
  function findOne(test, elems) {
    let elem = null;
    for (
      let i = 0, l = elems === null || elems === void 0 ? void 0 : elems.length;
      i < l && !elem;
      i++
    ) {
      const el = elems[i];
  ...
  var HTMLElement = class HTMLElement extends Node {
    ...
    set_content(content, options = {}) {
      if (content instanceof Node) content = [content];
        ...
        options = _objectSpread2(
          _objectSpread2({}, this._parseOptions),
          options
        );
    ...
    closest(selector) {
      ...
      while (el) {
        const e = selectOne(selector, el, {
          xmlMode: true,
          adapter: _objectSpread2(
            _objectSpread2({}, matcher),
            {},
            {
              getChildren(node) {
    ...
    get children() {
      ...
      for (const childNode of this.childNodes)
        if (childNode instanceof HTMLElement) children.push(childNode);
      return children;
    }
    /**
  ...
  function base_parse(data, options = {}) {
    ...
    const voidTag = new VoidTag(
      options === null ||
        options === void 0 ||
        (_options$voidTag = options.voidTag) === null ||
        _options$voidTag === void 0
        ? void 0
        : _options$voidTag.closingSlash,
      options === null ||
        options === void 0 ||
        (_options$voidTag2 = options.voidTag) === null ||
        _options$voidTag2 === void 0
        ? void 0
        : _options$voidTag2.tags
    );
    ...
    while ((match = markupPattern.exec(data))) {
      ...
      if (!leadingSlash) {
        ...
        if (
          !closingSlash &&
          !options.preserveTagNesting &&
          kElementsClosedByOpening[parentTagName]
        ) {
        ...
        if (is_block_text_element(tagName)) {
          ...
          const closeIndex = lowerCaseTagName
            ? data
                .toLocaleLowerCase()
                .indexOf(closeMarkup, markupPattern.lastIndex)
